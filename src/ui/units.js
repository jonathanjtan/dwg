// SD mobile suit renders from SD Gundam G Generation Wars (assets/units), shown beside names in the UI.
// Ids are the roster's suit ids plus the Zeon suits the officers fly.
export const UNITS = ['gundam', 'guncannon', 'guntank', 'zaku2', 'zaku2c', 'zaku2s'];
